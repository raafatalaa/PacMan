...

{
	...
	int Draw = 0;
	int ClearMenu = 0;
	double playerspeed = 0.35, enemyspeed = 0.3;
	int counter = 0;
	...
	Texture skull1;
	skull1.loadFromFile("background1.png");
	...
	player.setTextureRect(IntRect(64, 63, 48, 53));


	//Enemies Textures
	Texture enemyT1;
	enemyT1.loadFromFile("enemy1.png");
	Sprite enemy1(enemyT1);
	enemy1.setPosition(180.f, 460.f);
	enemy1.setTextureRect(IntRect(20, 0, 50, 55));
	...
	Texture enemyT3;
	enemyT3.loadFromFile("enemy3.png");
	...
	string name = " ";
	sf::Font grial;
	grial.loadFromFile("tahoma.ttf");

	//ScoreCounter
	std::ostringstream gsScore;
	gsScore << "Name :" << name;

	sf::Text gabelScore;
	gabelScore.setCharacterSize(40);
	gabelScore.setPosition(200.f, 550.f);
	gabelScore.setFont(grial);
	gabelScore.setString(gsScore.str());
	...
	RectangleShape youWin(Vector2f(800.f, 700.f));
	youWin.setPosition(0.f, 0.f);

	Texture win;
	win.loadFromFile("lolo.png");
	youWin.setTexture(&win);

	RectangleShape youlose(Vector2f(800.f, 700.f));
	youlose.setPosition(0.f,0.f);

	Texture lose;
	lose.loadFromFile("lolo2.PNG");
	...
	sf::Texture menuT;
	menuT.loadFromFile("background2.jpg");
